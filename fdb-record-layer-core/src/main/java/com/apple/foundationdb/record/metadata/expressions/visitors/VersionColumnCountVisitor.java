/*
 * VersionColumnCountVisitor.java
 *
...
/**
 * Visitor that returns the number of columns of type {@link VersionKeyExpression}.
 */
public class VersionColumnCountVisitor implements KeyExpressionVisitor<Integer> {
    @Override
    ...
    public Integer visit(@Nonnull FunctionKeyExpression function) {
        return function.versionColumns();
    }
